...
Pkg.develop(path="C:/Users/suqt0/OneDrive/Desktop/UQ/JMMenura")
...
## mat_alpha = 1.0 
# data = para_ref_data
trait_evol_func = trait_evol(trait_diffusion = trait_diffusion_cox_ingersoll_ross_gamma, dt = 0.01) ## CHANGE TRAIT DIFFUSION FUNCTION IF NEEDED to fit different evolutionary models. ALSO CHANGE TRAIT DIFFUSION FUNCTION IN Diffusion_Functions.jl IF NEEDED
mat_evol_func = mat_evol_affine(dt = 0.01)

# Same starting conditions as OU
start_trait_alpha = repeat([1.0], n) ## [2, 4, 6, 8]
start_trait_mu = repeat([1.0], n)
start_trait_sigma = repeat([sqrt(2)], n)

trait_start = repeat([1.0], n) ## start_trait_mu + 3*(start_trait_sigma ./ sqrt.(2*start_trait_alpha))
mat_start = P1
...
function kernel(distance, sigma) #final optimization
...
@save "C:/Users/suqt0/OneDrive/Desktop/UQ/JMMenura/paper_scripts/importance_simulated_scripts/simulated/Test Data sets and trees/newSim/CIRmodelled$i.BMtestdata.s2.5_5.r4.sP10.logE.mean.jld2" tst unrun
