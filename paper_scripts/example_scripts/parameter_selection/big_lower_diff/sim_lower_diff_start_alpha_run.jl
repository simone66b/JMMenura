...
run_result = menura_bayesian(para_ref_data, tree1, para, ones(n)*10.0, P1, threshold, n_particles, dt = 0.005, max_iter = 50000*n_particles, each = true)

@load "./s_big_lower_diff_result.jld2" sim_lower_diff_result

push!(sim_lower_diff_result, run_result)
