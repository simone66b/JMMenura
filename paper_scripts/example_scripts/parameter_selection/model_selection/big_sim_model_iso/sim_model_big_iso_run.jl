...
Iso_out = SimulatedModelSelection(iso_ref_data, model_sim_functions, priors, [threshold], n_particles, distance_function = dist_func,
max_iter = 20000*n_particles)

@load "./s_model_big_iso_result.jld2"

push!(s_model_big_iso_result, Iso_out)
