...
SimulatedModelSelection(ref_data, model_sim_functions, priors, [threshold], n_particles, distance_function = dist_func,
max_iter = 1)

run_result = SimulatedModelSelection(ref_data, model_sim_functions, priors, [threshold], n_particles, distance_function = dist_func,
max_iter = 20000*n_particles)

@load "./a_model_result.jld2" a_model_result

push!(a_model_result, run_result)
