using .JMMenura
using Phylo, Distributions, Pkg, Plots, DataFrames, XLSX
# read in data
...
thresholds = test_threshold(ref_data, tree, para, overall_trait_mean[2:end], cov_mean, 100)
...
out = menura_bayesian(ref_data, tree_anole, para, overall_trait_mean[2:end], cov_mean, threshold, 1)
